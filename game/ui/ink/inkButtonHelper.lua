...
local inkButtonHelper = {}

---@param buttonWidget inkWidget
---@param parentWidget inkWidget
---@return MenuItemController
function inkButtonHelper.ReuseButton(buttonWidget, parentWidget)
...
function inkButtonHelper.ApplyButtonStyle(buttonController, customStyle)
...
function inkButtonHelper.ApplyButtonState(buttonController, buttonState)
	local buttonWidget = buttonController:GetRootWidget()
